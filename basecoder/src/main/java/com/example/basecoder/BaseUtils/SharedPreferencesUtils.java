...
public class SharedPreferencesUtils {
    ...
    protected SharedPreferencesUtils() {
        mSharedPreferences = BaseApplication.getInstance().getSharedPreferences(SharedFILE_NAME, Context.MODE_PRIVATE);
    ...
    public static void setParam(String key, Object value) {
        SharedPreferences sharedPreferences = BaseApplication.getInstance().getSharedPreferences(SharedFILE_NAME, Context.MODE_PRIVATE);
